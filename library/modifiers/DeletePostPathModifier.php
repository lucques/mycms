<?php
	/**
	 * This class modifies a map by generating a path to a page to delete a post.
	 */
	class DeletePostPathModifier extends PathModifier
	{
		/**
		 * @param Map $settings
		 * @param string $field
		...
		{
			$destination = $this->settings->get('controllers.deletePost.destination');
