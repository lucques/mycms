<?php
	/**
	 * This class modifies a map by generating a path to a page to edit a post.
	 */
	class EditPostPathModifier extends PathModifier
	{
		/**
		 * @param Map $settings
		 * @param string $field
		...
		{
			$destination = $this->settings->get('controllers.editPost.destination');
