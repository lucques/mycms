<?php
	/**
	 * This criterion lets the mapper only select categories which are not assigned to any posts.
	 */
	class UnusedCategoriesCriterion extends AbstractCriterion implements CategoryCriterion
	{
		/**
